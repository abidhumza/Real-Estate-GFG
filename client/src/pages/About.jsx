...
export default function About() {
  return (
    <div className="bg-[#d8dfe7] m-5">
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-4xl lg:text-6xl font-bold mb-4 text-indigo-800 font-serif'>About Real Estate</h1>
      <p className='mb-4 text-gray-800 leading-loose'>
